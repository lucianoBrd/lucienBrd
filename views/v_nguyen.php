        ...
        <div class="row">
            <div class="blog-single col-md-8 col-md-offset-2">
                <div class="blog-image">
                    <img src="<?=PATH_IMG?>ngy.jpg" alt="nguyen">
                </div>
                <h1>Emilie Nguyen</h1>
                <div class="blog-detail"><span>Freelance</span> - 2017 </div>
                ...
                <ul class="list-style">
                    <li><a target="_blank" href="https://emilie-nguyen.com/"> Accéder au site. <i data-icon="H" class="icon"></i></a></li>
                    <li><a target="_blank" href="https://github.com/lucianoBrd/EmilieNguyen"> Accéder au git. <i data-icon="H" class="icon"></i></a></li>
                </ul>
